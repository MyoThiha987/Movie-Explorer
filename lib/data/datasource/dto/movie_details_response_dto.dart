...
class MovieDetailsResponseDto {
  ...
  MovieDetailsResponseDto(this.backdrop_path, this.id, this.original_title,
      this.overview, this.popularity, this.poster_path, this.release_date,
      this.vote_average, this.vote_count,this.production_companies);
